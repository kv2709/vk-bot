...
def generate_ticket(name, email):
    ...
    print("root_dir = sys.path.pop()")
    sys.path.append(root_dir)
    print("sys.path.append(root_dir)")
    abs_path_for_avatar_file = os.path.join(root_dir, 'files/ticket.png')
    print("abs_path_for_avatar_file = os.path.join(root_dir, 'files/ticket.png')")
    abs_path_for_font_file = os.path.join(root_dir, 'files/liberation-sans.ttf')
    print("abs_path_for_font_file = os.path.join(root_dir, 'files/liberation-sans.ttf'")
